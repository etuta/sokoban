...
# Function "dumbmenu" **************************************************
# **********************************************************************
def dumbmenu(screen, menu, x_pos=100, y_pos=100, size=70, distance=1.4,
             fgcolor=(255,255,255), cursorcolor=(255,0,0), exitAllowed=True):
    """Draws a Menu using pygame.
    
    Parameters are: screen, menu, x_pos, y_pos, size, distance,
                    fgcolor, cursorcolor
    ...
    cursorcolor (Tupel): Cursor-Color, means that ">"-Character
    ...
    print dumbmenu(screen, [
                            ...
                            'Manual',
                            'Show Highscore',
                            'Quit Game'], 320,250,32,1.4,green,red)
    ...
    code for me, but I think it could may useful for other people too...
    ...
    SPECIAL CHANGES FOR THIS BUNDLED RELEASE:
    =========================================
    - Key "q" now return ALWAYS the latest Menupoint.
    - "q" is the Key that can be pressed.
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_1:
                    ...
                    cursorpos = len(menu) - 1; exitMenu = True
